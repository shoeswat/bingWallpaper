...
# Version: 			1.0
# License: 			Use to your delight! Aknowledge me! That way I can tell others how cool I am.
# Description: 		Download Bing Wallpaper of the Day, modify the image, and set it as Linux Desktop background.
# Notes: 			Depending on how long it took for you to come here you might notice
# 					that this code looks similar to a lot of other scripts that do the same thing.
#					(e.g. See Marguerite Su's version) It would have taken me longer to do this without them.
# Libraries:		msttcorefonts (MS Fonts), exiftool (edit image metadata), Python v2.7.3 (or above?)
#					Python Image Library (PIL), others you'll find with the script errors
...
saveDir='/home/yoshi/Pictures/backgrounds/Fetch'
procDir='/home/yoshi/Pictures/backgrounds/Process'
